...
var readmeRaw = require('!!raw!../../../README.md'); // eslint-disable-line

var cx = _styleHelpers.lucidClassNames.bind('&-LandingPage');

var squareDelta = -60;
var damping = 30;

var LandingPage = (0, _createReactClass2.default)({
	...
	toggleCarpet: function toggleCarpet() {
		this.setState({ isCarpeted: !this.state.isCarpeted });
	},
	render: function render() {
		var _this = this;

		var isCarpeted = this.state.isCarpeted;
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'svg',
				{ className: cx('&-logo'), viewBox: '0 0 400.4 179.8', width: 400 },
				_react2.default.createElement(
					'g',
					null,
					_react2.default.createElement('path', { d: 'M50.6,140.8c-1.3,1.2-3,2.1-5.2,2.1s-3.9-0.9-5.2-2.1c-2.3-2.2-2.5-5.5-2.5-8.4c0-2.9,0.3-6.2,2.5-8.4 c1.3-1.2,3-2.1,5.2-2.1s3.9,0.9,5.2,2.1c2.3,2.2,2.5,5.5,2.5,8.4C53.1,135.3,52.9,138.6,50.6,140.8z M49.5,125 c-1.1-1-2.5-1.6-4.1-1.6c-1.6,0-3,0.5-4.1,1.6c-2,1.9-2.1,5-2.1,7.4c0,2.4,0.1,5.6,2.1,7.5c1.1,1,2.5,1.6,4.1,1.6 c1.6,0,3-0.5,4.1-1.6c2-1.9,2.1-5.1,2.1-7.5C51.6,130,51.5,126.9,49.5,125z' }),
					_react2.default.createElement('path', { d: 'M65.5,141.4c-0.9,0.9-2.2,1.5-3.9,1.5c-2,0-4-1.1-4.8-2.8v8.1h-1.4v-19.9h1.3l0.2,2.5c0.8-1.8,2.8-2.9,4.7-2.9 c1.6,0,2.8,0.5,3.8,1.3c1.6,1.4,2.3,3.7,2.3,6.1C67.7,137.7,67,140,65.5,141.4z M64.4,130.3c-0.7-0.6-1.6-1-2.8-1 c-1.3,0-2.2,0.5-2.9,1.1c-1.3,1.3-1.8,3-1.8,5c0,2.1,0.5,3.8,1.8,5c0.7,0.7,1.7,1.1,3,1.1c1.3,0,2.3-0.5,3-1.3 c1.1-1.2,1.6-3,1.6-4.8C66.2,133.4,65.7,131.4,64.4,130.3z' }),
					_react2.default.createElement('path', { d: 'M82,135.7H71.1c0,1.7,0.6,3.2,1.5,4.3c0.8,0.9,1.9,1.5,3.4,1.5c1.3,0,2.3-0.5,3.1-1.3c0.5-0.5,0.9-1.2,1.1-2 h1.5c-0.2,1.2-0.8,2.2-1.6,3c-1,1-2.4,1.7-4.1,1.7c-2.1,0-3.5-0.9-4.5-2c-1.2-1.4-1.8-3.2-1.8-5.4c0-1.8,0.3-3.6,1.4-5.1 c1.2-1.6,2.8-2.5,4.8-2.5c3.8,0,6.1,3.3,6.1,6.9C82,135.1,82,135.4,82,135.7z M75.9,129.2c-2.9,0-4.8,2.4-4.8,5.2h9.4 C80.5,131.7,78.8,129.2,75.9,129.2z' }),
					_react2.default.createElement('path', { d: 'M94.9,142.5v-9.3c0-2.5-1.1-3.9-3.7-3.9c-3.5,0-4.7,3-4.7,6.1v7.1h-1.4v-14.2h1.3l0.2,2.6c0.8-1.8,2.8-3,4.8-3 c3.3,0,5,2,5,5.2v9.4H94.9z' }),
					_react2.default.createElement('path', { d: 'M114.8,141.2c-1,1.1-2.7,1.7-4.6,1.7c-1.9,0-3.6-0.6-4.7-1.8c-0.8-0.9-1.1-1.7-1.2-2.9h1.5 c0.1,0.9,0.5,1.6,1.1,2.2c0.8,0.8,2,1.1,3.4,1.1c1.5,0,2.6-0.3,3.4-1.1c0.5-0.5,0.8-1,0.8-1.8c0-1.3-0.9-2.4-2.6-2.6l-2.8-0.4 c-1.2-0.1-2.4-0.5-3.2-1.4c-0.5-0.6-0.8-1.3-0.8-2.2c0-1.1,0.5-2.1,1.2-2.8c1-0.9,2.4-1.3,3.9-1.3c1.7,0,3.3,0.5,4.3,1.7 c0.7,0.8,1.1,1.7,1.1,2.6H114c-0.1-0.5-0.3-1.2-0.7-1.7c-0.7-0.8-1.8-1.3-3.2-1.3c-1.1,0-1.9,0.2-2.6,0.7c-0.7,0.5-1.1,1.2-1.1,2 c0,1.2,0.6,2.1,2.8,2.4l2.7,0.4c2.7,0.4,3.9,2.2,3.9,3.9C115.7,139.6,115.4,140.4,114.8,141.2z' }),
					_react2.default.createElement('path', { d: 'M128.1,141.2c-1,1-2.4,1.7-4.2,1.7c-1.8,0-3.2-0.7-4.2-1.7c-1.5-1.5-2-3.4-2-5.8c0-2.4,0.5-4.3,2-5.8 c1-1,2.4-1.7,4.2-1.7c1.8,0,3.2,0.7,4.2,1.7c1.5,1.5,2,3.4,2,5.8C130.1,137.8,129.6,139.7,128.1,141.2z M127.1,130.5 c-0.7-0.8-1.8-1.3-3.1-1.3c-1.4,0-2.4,0.5-3.1,1.3c-1.3,1.3-1.6,3-1.6,4.8c0,1.9,0.3,3.5,1.6,4.8c0.7,0.8,1.8,1.3,3.1,1.3 c1.4,0,2.4-0.5,3.1-1.3c1.3-1.3,1.6-3,1.6-4.8C128.7,133.5,128.4,131.9,127.1,130.5z' }),
					_react2.default.createElement('path', { d: 'M143.1,142.5l-0.2-2.6c-0.8,1.8-2.8,3-4.8,3c-3.3,0-5-2-5-5.2v-9.4h1.4v9.3c0,2.5,1.1,3.9,3.7,3.9 c3.5,0,4.7-3,4.7-6.1v-7.1h1.4v14.2H143.1z' }),
					_react2.default.createElement('path', { d: 'M154.8,129.5c-3.6,0-4.5,3.2-4.5,6.2v6.8h-1.4v-14.2h1.3l0.2,2.9c0.6-2,2.5-3,4.5-3c0.5,0,0.9,0,1.4,0.1v1.4 C155.7,129.5,155.3,129.5,154.8,129.5z' }),
					_react2.default.createElement('path', { d: 'M163,142.9c-1.8,0-3.2-0.7-4.2-1.7c-1.5-1.5-2-3.4-2-5.8c0-2.4,0.5-4.3,2-5.8c1-1,2.4-1.7,4.2-1.7 c3,0,5.2,1.9,5.5,4.8H167c-0.3-2-1.9-3.4-4-3.4c-1.4,0-2.4,0.5-3.2,1.2c-1.3,1.3-1.6,3-1.6,4.9c0,1.9,0.3,3.6,1.6,4.9 c0.7,0.8,1.8,1.2,3.2,1.2c2.2,0,3.7-1.5,4-3.5h1.5C168.2,140.8,166,142.9,163,142.9z' }),
					_react2.default.createElement('path', { d: 'M182.6,135.7h-10.9c0,1.7,0.6,3.2,1.5,4.3c0.8,0.9,1.9,1.5,3.4,1.5c1.3,0,2.3-0.5,3.1-1.3 c0.5-0.5,0.9-1.2,1.1-2h1.5c-0.2,1.2-0.8,2.2-1.6,3c-1,1-2.4,1.7-4.1,1.7c-2.1,0-3.5-0.9-4.5-2c-1.2-1.4-1.8-3.2-1.8-5.4 c0-1.8,0.3-3.6,1.4-5.1c1.2-1.6,2.8-2.5,4.8-2.5c3.8,0,6.1,3.3,6.1,6.9C182.6,135.1,182.6,135.4,182.6,135.7z M176.5,129.2 c-2.9,0-4.8,2.4-4.8,5.2h9.4C181.1,131.7,179.4,129.2,176.5,129.2z' }),
					_react2.default.createElement('path', { d: 'M195.4,142.5l-0.2-2.5c-0.8,1.8-2.8,2.9-4.7,2.9c-1.6,0-2.8-0.5-3.8-1.3c-1.6-1.4-2.3-3.7-2.3-6.1 c0-2.3,0.7-4.6,2.2-6c0.9-0.9,2.2-1.5,3.9-1.5c2,0,4,1.1,4.8,2.8v-8.7h1.4v20.6H195.4z M193.5,130.4c-0.7-0.7-1.7-1.1-3-1.1 c-1.3,0-2.3,0.5-3,1.3c-1.1,1.2-1.6,3-1.6,4.8c0,2,0.6,3.9,1.9,5.1c0.7,0.6,1.6,1,2.8,1c1.3,0,2.2-0.5,2.9-1.1c1.3-1.3,1.8-3,1.8-5 C195.3,133.3,194.8,131.6,193.5,130.4z' }),
					_react2.default.createElement('path', { d: 'M216.1,141.5c-0.9,0.8-2.2,1.3-3.8,1.3c-1.9,0-4-1.1-4.7-2.9l-0.2,2.5h-1.3v-20.6h1.4v8.7 c0.8-1.6,2.7-2.8,4.8-2.8c1.7,0,2.9,0.6,3.9,1.5c1.5,1.4,2.2,3.7,2.2,6C218.4,137.9,217.7,140.1,216.1,141.5z M215.4,130.5 c-0.7-0.8-1.7-1.3-3-1.3c-1.3,0-2.3,0.4-3,1.1c-1.3,1.2-1.8,2.9-1.8,5c0,2,0.5,3.7,1.8,5c0.7,0.7,1.7,1.1,2.9,1.1 c1.2,0,2.1-0.4,2.8-1c1.3-1.2,1.9-3.1,1.9-5.1C217,133.6,216.5,131.7,215.4,130.5z' }),
					_react2.default.createElement('path', { d: 'M225.1,145.5c-0.7,1.8-1.9,2.9-3.8,2.9c-0.5,0-1.3-0.1-1.8-0.3V147c0.6,0.1,1.2,0.2,1.7,0.2 c1.4,0,2.1-0.9,2.6-2.1l0.9-2.3l-5.8-14.5h1.5l5,12.6l4.8-12.6h1.5L225.1,145.5z' }),
					_react2.default.createElement('path', {
						id: 'XMLID_15_',
						d: 'M243.7,122l-7.2,20.6h3.7l1.3-4h8.1l1.3,4h3.9l-7.2-20.6H243.7z M242.8,135.1l2.9-8.6l2.9,8.6 H242.8z'
					}),
					_react2.default.createElement('path', {
						id: 'XMLID_12_',
					...
					_react2.default.createElement('rect', { x: '195.7', y: '36.8', width: '12', height: '12.4' }),
					_react2.default.createElement('path', { d: 'M86.2,91.2v12.4H37.5V91.2C37.5,91.2,86.4,91.2,86.2,91.2z' }),
					_react2.default.createElement(
						_reactMotion.Motion,
						{
							defaultStyle: {
							...
							style: {
								...
								x: (0, _reactMotion.spring)(37.5),
								y: (0, _reactMotion.spring)(36.7, { damping: damping })
							}
						},
						function (value) {
							return _react2.default.createElement('rect', {
					...
					_react2.default.createElement(
						_reactMotion.Motion,
						{
							...
							style: {
								opacity: (0, _reactMotion.spring)(1),
								x: (0, _reactMotion.spring)(37.5, { damping: damping }),
								y: (0, _reactMotion.spring)(54.9)
							}
						},
						function (value) {
							return _react2.default.createElement('rect', {
				...
				_react2.default.createElement(
					...
					{
						style: {
							opacity: (0, _reactMotion.spring)(isCarpeted ? 1 : 0),
							x: (0, _reactMotion.spring)(isCarpeted ? 140 : 20),
							y: (0, _reactMotion.spring)(isCarpeted ? 8 : -50)
						}
					},
					function (value) {
						return _react2.default.createElement(
			...
			_react2.default.createElement('div', {
				className: cx('&-readme'),
				dangerouslySetInnerHTML: (0, _util.toMarkdown)(readmeRaw)
			})
		);
	}
});
